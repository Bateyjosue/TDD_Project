...
> The Following are key features of the OOP school library application.

- **[A user can pass a certain number to the function `factorial`]**
- **[A user can pass a word to the functio `reverse` and get reverse of that word.]**
- **[A user can can passs a number to the function `fizzbuzz`.]**
...
```sh
  git clone https://github.com/Bateyjosue/TDD_Project.git
```
...
- [ ] **[Add student login UI ]**
- [ ] **[Add teacher Lodin UI]**
- [ ] **[Add book search function]**
